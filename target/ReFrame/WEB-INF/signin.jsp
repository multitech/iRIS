...
<body class="animated fadeInDown">
	...
	<header id="header">
		...
		<div id="logo-group">
			<span id="logo"> <img src="resources/img/logo.png" alt="SmartAdmin">
			</span>
		</div>
		...
		<div id="content" class="container">
			...
			<div class="row">
				<div
					...
					<h1 class="txt-color-red login-header-big">ReFrame</h1>
					<div class="hero">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
							<h5 class="about-heading">About ReFrame - Are you up to
								date?</h5>
