...
(function(m, ma) {
	...
	function sb(a, b, e) {
		...
		function g(w, I) {
			...
			R += "</tr></thead><tbody>";
			for (aa = 0; aa < w; aa++) {
				R += "<tr class='fc-week" + aa + "'> Market Risk ";
				for (V = 0; V < F; V++)
					R += "<td class='fc- "
							+ ea
							+ " fc-day"
	...
	var Ya = {
		...
		isRTL : false,
		firstDay : 0,
		monthNames : [ "Allianz", "S0405", "S0890", "AZFrance", "RC340", "RC040",
				"S0669", "AZItaly", "S0477" ],
		monthNamesShort : [ "Allianz", "S0405", "S0890", "AZFrance", "RC340", "RC040",
		    				"S0669", "AZItaly", "S0477" ],
		dayNames : [ "Allianz", "S0405", "S0890", "AZFrance", "RC340", "RC040",
						"S0669", "AZItaly", "S0477" ],
		dayNamesShort : [ "Allianz", "S0405", "S0890", "AZFrance", "RC340", "RC040",
		  				"S0669", "AZItaly", "S0477" ],
		buttonText : {
			prev : "&nbsp;&#9668;&nbsp;",
			next : "&nbsp;&#9658;&nbsp;",
