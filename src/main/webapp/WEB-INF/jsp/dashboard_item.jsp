                    ...
                    <div class="panel-body minimal">
                        <div class="mail-option">
								...
								<div class="btn-group" id="uploadButton">
                                          <button class="btn btn-theme" type="submit" ><i class="fa fa-upload"></i> Upload</button>
                                      </div>
								<div class="btn-group" id="fetchButton">
                                          <button class="btn btn-theme" type="submit" ><i class="fa fa-database"></i> Fetch</button>
                                      </div>
